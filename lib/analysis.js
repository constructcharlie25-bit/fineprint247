...
const CONTRACT_TYPE_FOCUS = {
  msa: [
    ...
    'Pay special attention to: the term and auto-renewal clauses; termination',
    'for convenience and any kill fee for work in progress; liability caps and',
    'whether they apply across all statements of work; payment terms, invoicing,',
    'and late-payment interest; and whether individual SOWs can override these',
    'terms. Flag anything that locks the freelancer into unfavorable terms for',
    'the life of the agreement.',
  ].join('\n'),
  sow: [
    'CONTRACT TYPE: Statement of Work (SOW).',
    'This defines a specific engagement: deliverables, timeline, and price.',
    'Pay special attention to: vague or open-ended deliverables; acceptance',
    'criteria and who decides a milestone is complete; the change-order process',
    'for out-of-scope requests; payment milestones versus actual delivery dates;',
    'and unlimited revision requirements. Scope creep is the biggest risk in',
    'SOWs — call it out directly.',
  ].join('\n'),
  nda: [
    'CONTRACT TYPE: Non-Disclosure Agreement (NDA).',
    'Pay special attention to: whether confidentiality duties are mutual or',
    'one-sided; the survival period of confidentiality obligations; carve-outs',
    'for information the freelancer already knew or that becomes public; how',
    'broadly "Confidential Information" is defined; and any non-compete or',
    'non-solicit clauses smuggled into the NDA. Flag anything that restricts',
    "the freelancer's future work beyond genuine confidentiality needs.",
  ].join('\n'),
  ica: [
    'CONTRACT TYPE: Independent Contractor Agreement.',
    'Pay special attention to: IP assignment scope — pre-existing tools and',
    'templates versus work created for this engagement; termination for',
    'convenience and any kill fee for work in progress; payment terms and',
    'late-payment interest; non-compete and non-solicit restrictions; and any',
    'terms that resemble employment (set hours, exclusivity, direct day-to-day',
    'supervision) — flag the tension for the freelancer to ask about, but do',
    'NOT conclude anything about worker classification.',
  ].join('\n'),
  lease: [
    'CONTRACT TYPE: Lease.',
    'Pay special attention to: rent escalation clauses and annual increases;',
    'who pays for maintenance, repairs, and utilities; early-termination terms',
    'and penalties; the security deposit and the conditions for its return;',
    'automatic renewal or notice deadlines; and any personal guarantee. Flag',
    'anything that makes the lease hard or expensive to exit.',
  ].join('\n'),
};
